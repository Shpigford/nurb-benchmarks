...
def leg_cup(clearance=0.4, wall=2.0, pocket_depth=8.0, draft=False):
    ...
    wall: how thick the cup's walls are
    ...
    pocket = Pos(0, 0, outer_height / 2 - pocket_depth / 2) * Box(
    ...
    # The pocket is a mating socket for the leg's foot: its walls and floor stay
    # sharp, and they are already concave, so excluding concave edges is enough.
