"""Flawed: a solid block wearing the right bounding box. The clip's whole function
is missing, which only the floor and volume assertions can see."""
